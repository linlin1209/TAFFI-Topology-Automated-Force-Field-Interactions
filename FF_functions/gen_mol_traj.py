...
from kekule import *
from gen_md_for_sampling import get_data, initialize_VDW, Write_data, Pack_Box, write_map, write_molecule
...
class Logger(object):
    def __init__(self,folder):
        ...
        self.log = open(folder+"/gen_mol_traj.log", "a",buffering = 1)
