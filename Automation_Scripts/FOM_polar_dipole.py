...
def xyz_to_orca(Geometry,Elements):
    random_factor = 0.0
...
def polar_orca(Geometry,Elements):
   random_factor = 0.0
...
def parse_configuration(args):
    ...
    keywords = [ "PARAM_GEOOPT_PROCS","PARAM_GEOOPT_WT","PARAM_GEOOPT_Q","PARAM_GEOOPT_SCHED","PARAM_GEOOPT_PPN","PARAM_GEOOPT_SIZE",\
                 ...
                 "fom_t_ext", "fom_t_tot", "fom_t_a","fom_restarts", "fom_t_equil","CHARGE","GENS","FOM_DENS" ]
