...
def main(argv):
    ...
    lone_electrons,bonding_electrons,core_electrons,bond_mat,fc = find_lewis(elements,adj_mat,q_tot=0,keep_lone=[],return_pref=False,verbose=True,return_FC=True)
    ...
    print( "idx {:20s} {:20s} {:20s}".format("Element","hybridization","atomtype"))
    for count_i,i in enumerate(atom_types):
        print( "{:<2d}: {:20s} {:20s} {:40s}".format(count_i,elements[count_i],hybridizations[count_i],i))
    print( "\nadj_mat:")
    for i in adj_mat:
        print(i)
    print( "\nbond_mat(s):")
